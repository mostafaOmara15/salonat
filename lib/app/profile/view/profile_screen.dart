            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    widthSpace(context.width * 0.025),
                    mediumTitle("about".tr(), ColorManager.blackColor, false).onTap((){}),
                    SizedBox(
                    ...
                    RichText(
                      text: TextSpan(
                        style: GoogleFonts.fraunces(
                          textStyle: TextStyle(color: ColorManager.darkGreyColor, letterSpacing: 0.5)),
                        children: <TextSpan>[
                          TextSpan(
                            text: "reviews".tr(),
                            style: GoogleFonts.fraunces(
                ...
                heightSpace(context.height * 0.01),
                aboutTheSalon('Nirvana Spa is a luxurious space with 6 treatment rooms for women and 4 for men, offering a full range of body treatments, facials and massages. At Nirvana Spa, we have a modern and fully equipped Fitness Centre, along with a Health Club that offers jacuzzi, sauna, steam.'),
                ...
                Row(
                  children: [
                    ...
                    smallTitle("at Grand Hyatt al khobar hotel and residences", ColorManager.darkBrownColor, false)
                  ],
                ),
                heightSpace(context.height * 0.015),
                Row(
                ...
                ProfileTile(title: "services".tr(), navigatedScreen: const SplashScreen()),
