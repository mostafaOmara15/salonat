...
class ColorManager{
  static Color primaryColor = const Color(0xffEED6D0);
  static Color lightPrimaryColor = const Color(0xffF9F1EF);
  static Color opacityPrimaryColor = const Color(0xffEFE0DC);
  ...
  static Color primaryColor100 = const Color(0xff9B8B87);
}